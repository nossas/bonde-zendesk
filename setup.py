...
setup(
    name='tapioca-zendesk',
    version=get_version(package),
    description='zendesk API wrapper using tapioca',
    long_description=readme,
    author=get_author(package),
    author_email=get_email(package),
    url='https://github.com/igr-santos/tapioca-zendesk',
    packages=[
        'tapioca_zendesk',
    ],
    package_dir={'tapioca_zendesk': 'tapioca_zendesk'},
